...
// Una clase abstracta es aquella que no se puede implementar, las clases abstractas pueden ser heredadas
//  similar a las interfaces, pero estas si pueden contener metodos desarrollados tienen metodos implementados
